    ...
    <div className="relative flex w-full flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
      ...
      <div className="p-6 flex justify-between items-center">
        <div className="flex flex-col">
          <div
            data-tooltip="money"
            className="z-50 whitespace-normal break-words rounded-lg bg-pink-500 py-1.5 px-3 font-sans text-sm font-medium text-white focus:outline-none w-fit cursor-pointer mb-3"
          >
